    ...
    <div className="px-2 py-2 max-w-lg mx-auto">
      ...
      <div className="mb-4 p-4 bg-black/40 backdrop-blur-md rounded-lg border border-yellow-500/30">
        <div className="flex items-center justify-between mb-2">
          <span className="text-sm text-yellow-500/70 font-mono">Coin</span>
          <span className="px-2 py-0.5 bg-yellow-500/20 text-yellow-400 rounded text-xs font-medium border border-yellow-500/30">
            {metadata?.symbol}
          </span>
        </div>
        <div className="flex items-center justify-between mb-2">
          <span className="text-sm text-yellow-500/70 font-mono">Balance</span>
      ...
      {!result ? (
        <div className="space-y-4">
          ...
          <div>
            <div className="flex items-center justify-between mb-1">
              <label className="text-sm text-yellow-500/70 font-mono">Recipient Address</label>
                ...
                <div className="relative" ref={dropdownRef}>
                  ...
                  {showWalletDropdown && (
                    <div className="absolute right-0 top-full mt-1 w-64 bg-black/90 backdrop-blur-md border border-yellow-500/30 rounded-lg shadow-lg z-50 overflow-hidden">
                      <div className="px-3 py-2 bg-yellow-500/10 border-b border-yellow-500/20 text-[10px] text-yellow-500/70 font-mono">
          ...
          {/* Amount */}
          <div>
            <label className="block text-sm text-yellow-500/70 font-mono mb-1">Amount</label>
            <div className="relative">
              ...
              <button
                ...
                className="absolute right-2 top-1/2 -translate-y-1/2 px-2 py-1 text-[10px] bg-yellow-500/20 text-yellow-400 rounded hover:bg-yellow-500/30"
              >
                MAX
              </button>
            </div>
          ...
          {estimatedGas && (
            <div className="p-3 bg-black/30 border border-yellow-500/20 rounded-lg text-sm">
              <span className="text-yellow-500/70 font-mono">Estimated Gas:</span>{' '}
        ...
        <div className={`p-4 rounded-lg ${result.success ? 'bg-green-500/10 border border-green-500/30' : 'bg-red-500/10 border border-red-500/30'}`}>
          ...
          {result.digest && (
            <div className="mb-3">
              <div className="text-xs text-yellow-500/70 font-mono mb-1">Transaction Digest</div>
              <div

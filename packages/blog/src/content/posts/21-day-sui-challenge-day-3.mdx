...
<figure className="my-8">
  <BrandedImage
    client:visible
    src="/blog/images/posts/21-day-sui-challenge/day-3-test-results.png"
    alt="Day 3 Move tests passing - structs and abilities"
    width={800}
    height={600}
    watermark="cli.firstmovers.io"
  />
  <figcaption className="text-center text-white/50 text-sm mt-3">
    All 17 tests passing — structs, abilities, and patterns working correctly
  </figcaption>
</figure>

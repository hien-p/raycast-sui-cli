...
export function CommunityJoin({ onClose, compact = false }: CommunityJoinProps) {
  const {
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <div className="text-xs text-white/60 mt-0.5">
              {stats.totalMembers.toLocaleString()} builders · Tier system · NFT cards
            </div>
          </div>
          {isMember && tierInfo && (
  ...
  return (
    <div className="p-6 max-w-md mx-auto">
      ...
      <div className="text-center mb-6">
        ...
        <h2 className="text-xl font-bold text-foreground">Join Sui CLI Web Community</h2>
        <p className="text-sm text-muted-foreground mt-2">
          Earn tiers, track achievements, and get your unique NFT card
        </p>
      </div>
